...
/**
 * @ClassName AttributeContains
 * @Description:    控件属性contains校验
 * @Author Sniper
 * @Date 2019/5/22 10:46
 */
public class AttributeContains implements AssertionHandler {
	...
	public Object assertion(AppiumDriver<MobileElement> appiumDriver, AssertionCommand assertionCommand)
		...
		return new AppiumDriverWait(appiumDriver).until(ExpectedConditions.attributeContains(assertionCommand.assertBy(),
				attribute, value));
	}
}
